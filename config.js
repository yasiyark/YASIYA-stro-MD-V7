...
INBOX_BL_MSG: process.env.INBOX_BL_MSG === undefined ? 'false' : process.env.INBOX_BL_MSG,
HOST: process.env.HOST === undefined ? '-' : process.env.HOST,
SESSION_ID: process.env.SESSION_ID === undefined ? 'ASTRO=JnB3mL6J#zrR_uQIJz7g7grBftGBVuND3h1zxLayQ1dzfYDHK4og' : process.env.SESSION_ID
};
